...
function InitBerniisGaugeLib() {
  ...
  TextRenderer = (function() {
    ...
    function GetColor(staticZones,value)
    {
      
      for (var j=0;j<staticZones.length;j++)
      {
        if (value>=staticZones[j].min&&value<staticZones[j].max) return staticZones[j].strokeStyle;
      }
